...
'@
    ...
    if ($nonAdminLoggedOn -eq $false) {
        ...
        $starturl = "https://github.com/bianca-betterrehab/Public/raw/main/start2.bin"
...
############################################################################################################
#                                        Remove Any other installed programs                               #
#                                                                                                          #
############################################################################################################
...
if ($mcafeeinstalled -eq "true") {
    ...
    # Download Source
    $URL = 'https://github.com/bianca-betterrehab/Public/raw/main/mcafeeclean.zip'
    ...
    write-output "Downloading McAfee Removal Tool"
    # Download Source
    $URL = 'https://github.com/bianca-betterrehab/Public/raw/main/mccleanup.zip'
...
##Download the ODT
$odturl = "https://github.com/bianca-betterrehab/Public/blob/main/odt.exe"
